# About project
This repository was created for educational purposes for practical study **React** and **TypeScript** technologies.
It's a task list application in which has the following features: 
- Add item
- Delete item
- Mark item done
- Unmark item done
